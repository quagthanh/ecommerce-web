    ...
    <div className="mynavbar">
      ...
      <div className="bottomnavbar">
        <div className="nav-logo">
          <Link to="/">
            <img onClick={() => setMenu("shops")} src={thechip} alt="logo" />
          </Link>
        ...
        <ul className="nav-menu">
          ...
          <li onClick={() => setMenu("mens")}>
            <Link style={{ textDecoration: "none", color: "#111" }} to="/mens">
              Men{menu === "mens" ? <hr /> : <></>}
            </Link>
          </li>
          ...
          <li onClick={() => setMenu("kids")}>
            <Link style={{ textDecoration: "none", color: "#111" }} to="/kids">
              Kids{menu === "kids" ? <hr /> : <></>}
            </Link>
          </li>
        </ul>
        <div className="nav-login-cart">
          ...
          <Link to="/favorite">
            <img className="heart-icon" src={heart_icon} alt="heart_icon" />
          </Link>
          <Link to="/cart">
